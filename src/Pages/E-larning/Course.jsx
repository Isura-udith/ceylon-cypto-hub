...
const Course = () => {
  ...
  const courses = [
    ...
    { id: 5, title: 'Chart Patterns and Technical Analysis', description: 'Gain in-depth knowledge of chart patterns and their significance in predicting market movements. Learn to identify and utilize these patterns to enhance your trading decisions.', instructor: 'Samantha Green', rating: 4.6 },
  ];
